...
function HamburgerDropdown({isOpen, toggle, reload}) {
    return (
        <div className={isOpen ? 'grid grid-flow-rows z-30 text-center w-full items-center absolute bg-gray-100 mt-16' : 'hidden'} onClick={toggle}>
            ...
            {/* <div className='font-bold p-3 border-black border-b-2 border-t-0 border-l-0 border-r-0'>Contact</div> */}
