    ...
    <div className='h-[max-content] w-full overflow-hidden'>
      ...
      <div className='min-h-screen w-full hidden xl:block '>
		...
		<div className="h-[100vh]  fixed top-0 w-full ">
          ...
          <h2 onClick={() => router.push('https://kito.online')} className="font-title cursor-pointer text-3xl font-semibold tracking-wide italic border-2 border-gray-700 p-3 rounded-md shadow-lg hover:text-white hover:bg-black transition duration-300 hover:scale-105 backdrop-blur-sm ">Jaguar Runner Raffle - Live Now hi</h2>
        </div>
