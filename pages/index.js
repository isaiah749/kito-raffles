    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="px-5 pb-5 mt-16 ">
        ...
        <section className='max-w-7xl mt-5 mx-auto'>
          <div className="w-full h-auto border border-black p-2 text-center px-2 flex flex-col items-center text-lg justify-center">
            <p className='px-3 max-w-3xl font-title text-[1.3rem] my-2 sm:text-[1.5rem]'>Welcome to Kito-Raffles!</p>
        ...
        <section className='max-w-7xl mt-5 mx-auto h-auto max-w-96 border border-black grid gap-2 md:grid-cols-2 md:w-[80%] lg:grid-cols-4 grid-rows-md-mason p-3'>
