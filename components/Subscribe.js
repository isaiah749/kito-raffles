			...
			<form
				...
				<div className='mb-4 sm:m-2 md:m-4'>
					...
					<input
						...
						id='subFirstName'
						name='subFirstName'
						className='w-56 ml-1 focus:outline-none p-1 border border-black rounded-sm text-sm'
						placeholder='First Name'
					/>
				</div>
				<div className='mb-4 sm:m-2 md:m-4'>
					<label htmlFor='subLastName' className='text-xs block mb-1 font-bold'>
						Last Name:
					</label>
					<input
						type='text'
				...
				<div className='mb-4 sm:m-2 md:m-4'>
					<label htmlFor='subEmail' className='text-xs block mb-1 font-bold'>
						Email:
					</label>
					<input
						type='email'
				...
				<div className='mb-4  sm:m-2 md:m-4 flex-wrap justify-center flex'>
					<div className='sub-country-container'>
						<label htmlFor='subCountry' className='text-xs block mb-1 font-bold'>
							Country:
						</label>
						<Listbox
							id='subCountry'
							...
							<Listbox.Options className='border-black border border-l-0 border-r-0 border-b-0 text-sm max-h-24 w-full overflow-scroll'>
								{countries.map((country, index) => (
									<Listbox.Option
										className='border border-black border-t-0 border-l-0 border-r-0'
										key={index}
										value={country}>
										{country.country}
									</Listbox.Option>
					...
					<div className='sub-phone-container'>
						<label htmlFor='subPhoneNumber' className='text-xs block mb-1 font-bold'>
							Phone Number:
						</label>
						<input
							type='number'
					...
					<div className='checkbox-container mt-3 sm:mt-0  relative'>
						...
						<label htmlFor='subCheckbox' className='checkmark text-xs'>
							<p className='ml-4 text-center'>
								...
								<span className='text-underline'>Terms of Serivce & Privacy Policy.</span> Reply{' '}
								<span className='font-bold'>STOP</span> to cancel,{' '}
								<span className='font-bold'>HELP</span> for help. Msg* & data rates may apply.
							</p>
						</label>
					</div>
				</div>
