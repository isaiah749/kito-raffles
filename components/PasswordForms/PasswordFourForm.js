...
import { db, passwordFourCol, addDoc } from "../../firebase/firebase";
...
const PasswordFourForm = () => {
  ...
  return (
    <section className="border-2 mt-5 h-[max-content] bg-white text-black border-black w-full mx-auto max-w-[700px] ">
      <form onSubmit={entrySubmit} id="entryForm">
        <h2 className="font-bold text-xl px-2 w-[fit-content] ">
          Enter Phone Number
        </h2>
        <h2 className="text-xl -mt-2 pl-[15px] w-[fit-content] mb-3 ">
...
export default PasswordFourForm;
